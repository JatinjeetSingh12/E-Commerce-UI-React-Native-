...
const SearchbyCategory: FC<props> = ({ data }) => {
    return (
        <Box>
            ...
            <Center borderWidth={1} borderRadius={5} borderColor={'silver'} mx={2}>
                {data.map((item, index) => {
                    return (
                        <TouchableOpacity key={index} 
                        style={{ paddingVertical: 10, marginVertical: 5, borderBottomWidth: 0.2, width: '95%',borderBottomColor:'silver' }}>
