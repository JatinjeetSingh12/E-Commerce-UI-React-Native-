...
const Items_wishlist: FC = () => {
  return (
    <VStack space={4} alignItems={'center'} my={120}>
      ...
      <Text fontWeight={'600'} fontSize={20}>THERE ARE 0 ITEMS IN WHISH LIST.</Text>
      <Text fontSize={'13'} alignSelf={'center'}>Add items to wish list and check price and inventory information</Text>
    </VStack>
  )
}
